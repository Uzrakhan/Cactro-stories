...
const Stories = () => {
    ...
    useEffect(() => {
        let timer;
        if (isViewerOpen && progress < 100 && !isLoading && !isPaused) {
            timer = setTimeout(() => {
    ...
    }, [progress, isViewerOpen, isLoading, isPaused]);
        ...
        <div className='max-w-md mx-auto relative h-screen bg-black'>
            ...
            {isViewerOpen && currentStory && (
                <div className='fixed inset-0 bg-black'
                    ...
                    onTouchEnd={(e) => { handleTouchEnd(e); setIsPaused(false) }}
                >
                    <div className='absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-black/70 to-transparent z-10'>
                        <div className='absolute top-0 left-0 right-0 z-30 flex items-center px-4 pt-6'>
                            <img 
                    ...
                    {currentStory.caption && (
                        <div className="absolute bottom-20 left-0 right-0 px-4 text-center z-30">
                            <p className="text-white text-xl font-medium bg-black/50 rounded-lg p-2 inline-block mt-3">
                                {currentStory.caption}
                            </p>
                        </div>
                    )}
